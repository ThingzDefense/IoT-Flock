...
public:
    dlUseCase();
    int Insert(objUseCase _objUseCase);
    QList<objUseCase> GetUseCaseList();
    bool isUseCaseExists(objUseCase _objUseCase);
    objUseCase GetUseCaseByID(int useCaseID);
    bool DelUseCase(int useCaseID);
};
