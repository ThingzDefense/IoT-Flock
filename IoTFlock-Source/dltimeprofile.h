 ...
 *                                                                         *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#ifndef DLTIMEPROFILE_H
#define DLTIMEPROFILE_H
#include<dal.h>
...
public:
    ...
    dlTimeProfile();
    int Insert(objTimeProfile _objTimeProfile);
    QList<objTimeProfile> GetTimeProfileList();
    objTimeProfile GetTimeProfile(int id);
    bool DelTimeProfile(int id);
    bool UpdateTimeProfile(objTimeProfile _objTimeProfile);


};

#endif // DLTIMEPROFILE_H
