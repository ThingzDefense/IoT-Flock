 ...
 *                                                                         *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#ifndef DLDATAPROFILE_H
#define DLDATAPROFILE_H
...
public:
    ...
    dlDataProfile();
    int Insert(objDataProfile _objDataProfile);
    QList<objDataProfile> GetDataProfileList();
    objDataProfile GetDataProfile(int id);
    bool DelDataProfile(int id);
    bool UpdateDataProfile(objDataProfile _objDataProfile);

};

#endif // DLDATAPROFILE_H
