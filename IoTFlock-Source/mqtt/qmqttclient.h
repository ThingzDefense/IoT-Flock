...
#include "qmqttglobal.h" //<QtMqtt/qmqttglobal.h>
#include "qmqttsubscription.h" //<QtMqtt/qmqttsubscription.h>
#include "qmqtttopicfilter.h" //<QtMqtt/qmqtttopicfilter.h>
...
private:
    ...
    Q_PROPERTY(QString attackType READ attackType WRITE setAttackType NOTIFY attackTypeChanged) //Added by Faisal
...
public:
    ...
    QString attackType() const; //Added by Faisal
    quint16 port() const;
...
Q_SIGNALS:
    ...
    void attackTypeChanged(QString hostname);//Added by Faisal
...
public Q_SLOTS:
    ...
    void setAttackType(const QString &attackType);//Added by Faisal
