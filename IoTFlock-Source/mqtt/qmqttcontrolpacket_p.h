...
public:
    ...
    QMqttControlPacket(quint8 header,QString CVE);
    ...
    //code added by ghazanfar start
    void append(const QByteArray &data,const QString CVE);
    //code added by ghazanfar end
